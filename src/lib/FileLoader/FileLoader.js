...
export const FileLoader = ({ handleChange, }) => {
    ...
    return (_jsxs("div", { className: styles.SFileWrapper, children: [_jsx("div", { className: styles.SFileTitle, children: "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0444\u043E\u0442\u043E \u0438\u043B\u0438 \u043F\u0435\u0440\u0435\u0442\u0430\u0449\u0438\u0442\u0435 \u0441\u044E\u0434\u0430" }), _jsx("input", { type: "file", name: "f", style: {
                    position: 'absolute',
                    width: '100%',
                    height: '100%',
                    opacity: 0,
